...
const ToolTip = (props: ToolTipProps) =>
    <motion.div className="relative group/tooltip" whileHover="hover">
        {props.children}
        <motion.div
        ...
        >
            ...
            <motion.span
                className="
                pointer-events-auto p-1 px-2 text-center rounded-lg bg-white shadow border border-white text-xs
                whitespace-pre
                "
